...
public class EditorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        suppEdit = (EditText) findViewById(R.id.supp);
        ...
        imageBtn = (Button) findViewById(R.id.img_btn);
    ...
    private boolean addItemToDb() {
        ...
        if (currentItemId == 0) {
            InventoryItem item = new InventoryItem(
                    ...
                    suppEdit.getText().toString().trim(),
    ...
    private void addValuesToEditItem(long itemId) {
        ...
        suppEdit.setText(cursor.getString(cursor.getColumnIndex(StockEntry.COLUMN_SNAME)));
        ...
        imageView.setImageURI(Uri.parse(cursor.getString(cursor.getColumnIndex(StockEntry.COLUMN_IMAGE))));
    ...
    private int deleteOneItemFromTable(long itemId) {
        ...
        int rowsDeleted = database.delete(
                StockEntry.TABLE_NAME, selection, selectionArgs);
        return rowsDeleted;
    }
